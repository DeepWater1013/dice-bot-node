...
exports.index = function(req, res) {
    res.render('index', { title: 'Kirolos\'s Dice Bot',skin:req.session.skin });
};
...
exports.login = async function(req, res) {
    try{
        if(typeof req.body.username !== 'undefined'){
            ...
            if(ret != true){
                res.render('login', {title: 'Kirolos\'s Dice Bot',message:ret,site:req.params.site,skin:req.session.skin});
            } else {
                res.redirect(req.protocol+"://"+req.headers.host+"/"+req.body.site+"/info");
            }
        } else {
            //Factory.clear();
            res.render('login',{title: 'Kirolos\'s Dice Bot',site:req.params.site,skin:req.session.skin});
        }
    } catch(err) {
        console.log(err);
        res.render('login', {title: 'Kirolos\'s Dice Bot',message:err.toString(),site:req.params.site,skin:req.session.skin});
    }
};
